...
export class gabememory{
    ...
    PPUreadByte(address){
       ...
       if(address>=0xC000) return this.bigmemory[address&0xFFFF];
...
return this.bigmemory[address&0xFFFF];
    ...
    readByte(address){
       ...
       // if(address==0xFF41) console.log(this.bigmemory[address].toString(2));
            ...
            if(this.ppuinfo.mode===3){
                if(address>=0xFE00&&address<=0xFE9F) vramchecker = false;
                if(address>=0x8000&&address<=0x9FFF) vramchecker = false;
            }
            if(this.OAMtransfercycle>0){
                if(address<0xFF00) vramchecker = false;
            ...
            if(address>=0xFF00&&address<=0xFF7F){
                switch(address){
                    ...
                    case 0xFF02:
                        ...
                        this.bigmemory[address] = value | 0x7E;
                        this.vramchecker = false;
                        if(value&0x80){

                            

                            if(value&0x01)this.serialwait = 1024;
                            else this.serialwait = 0;
